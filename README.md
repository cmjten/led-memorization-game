...
The goal of the game is to to repeat the randomly generated sequence of LEDs. A player must play sequences equal to the current level in order to level up, and once all the sequences in the maximum level have been played, the player wins.
...
### Instructions
- Load the IRrecvDemo sketch onto your Arduino Uno in the examples folder of the Arduino IRremote library to get the hexadecimal codes for your IR remote. Write them down.
